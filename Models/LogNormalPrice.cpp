...
#include "LogNormalPrice.h"

LogNormalPrice::LogNormalPrice(std::size_t TimeSteps_, double TimeToMaturity_, double StartPrice_, double RiskFreeRate_,
...
void LogNormalPrice::RunModelOnce() {
...
void LogNormalPrice::RunModelOnce(AssetPriceData& ResultsRef_) {
